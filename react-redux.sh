...
then echo "
------------------------------------------
react-redux directory exists, cant proceed
No changes are done
exiting ...
------------------------------------------
"
...
wget -qO - https://github.com/microverseinc/linters-config/archive/master.tar.gz | tar zx --strip-components=1 linters-config-master/react-redux/

echo "Required files downloaded..., Configuring ESLint..."

# move the .github directory from the source directory react-redux
mv ./react-redux/.github .
